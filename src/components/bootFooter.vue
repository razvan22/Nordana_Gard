    ...
    <div id="footer" >
        <div class="container">
            <div class="row d-flex justify-content-center pt-3">
                 <div class="col-sm-12 col-md-4 d-flex justify-content-center"><h4>LOCATION</h4></div>
                 <div class="col-sm-12 col-md-4 d-flex justify-content-center"><h4>MENU</h4></div>
                 <div class="col-sm-12 col-md-4 d-flex justify-content-center"><h4>CONTACT</h4></div>
            </div>
            <!-- <div class="row">
